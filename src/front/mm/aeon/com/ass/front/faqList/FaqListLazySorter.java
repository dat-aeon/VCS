...
public class FaqListLazySorter implements Comparator<FaqListLineBean> {
    ...
    public FaqListLazySorter(String sortField, SortOrder sortOrder) {
        this.sortOrder = sortOrder;
        this.sortField = sortField;
    }

    public int compare(FaqListLineBean member1, FaqListLineBean member2) {
