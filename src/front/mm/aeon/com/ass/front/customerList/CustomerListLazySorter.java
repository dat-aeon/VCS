...
public class CustomerListLazySorter implements Comparator<CustomerListLineBean> {
    ...
    public CustomerListLazySorter(String sortField, SortOrder sortOrder) {
        this.sortOrder = sortOrder;
        this.sortField = sortField;
    }

    public int compare(CustomerListLineBean member1, CustomerListLineBean member2) {
