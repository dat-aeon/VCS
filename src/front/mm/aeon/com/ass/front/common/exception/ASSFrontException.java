 ...
 * 
 */
public class ASSFrontException extends PrestoRuntimeException{
    /**
     * Default serial Id.
     */
     ...
     */
    public ASSFrontException(String message) {
        super(message);
    }
     ...
     */
    public ASSFrontException(Throwable cause) {
        super(cause);
     ...
     * 
     */
    public ASSFrontException(String message, Throwable cause) {
        super(message, cause);
    }
