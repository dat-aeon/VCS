...
public class ApplicationListLazySorter implements Comparator<ApplicationListLineBean> {
    ...
    public ApplicationListLazySorter(String sortField, SortOrder sortOrder) {
        this.sortOrder = sortOrder;
        this.sortField = sortField;
    }

    public int compare(ApplicationListLineBean member1, ApplicationListLineBean member2) {
