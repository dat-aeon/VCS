...
public class ImportMembewrListLazySorter implements Comparator<ImportMemberListLineBean> {
    ...
    public ImportMembewrListLazySorter(String sortField, SortOrder sortOrder) {
        this.sortOrder = sortOrder;
        this.sortField = sortField;
    }

    public int compare(ImportMemberListLineBean member1, ImportMemberListLineBean member2) {
