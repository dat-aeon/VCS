...
public class OperatorMessagingManagementController extends AbstractController
    ...
    public OperatorListFormBean process(OperatorListFormBean formBean) {
        ...
        applicationLogger.log("Operator Allow Messaging started.", LogLevel.INFO);
        ...
        updateReqBean.setAllowMessagingFlag(1);

        this.getServiceInvoker().addRequest(updateReqBean);
        ResponseMessage responseupdateMessage = this.getServiceInvoker().invoke();

        AdminCustomerRoomInsertServiceReqBean adminCustomerRoomInsertServiceReqBean =
                new AdminCustomerRoomInsertServiceReqBean();
        AdminCustomerRoomInsertServiceResBean adminCustomerRoomInsertServiceResBean =
                new AdminCustomerRoomInsertServiceResBean();
        ...
        adminCustomerRoomInsertServiceResBean = responseMessage.getMessageBean(0);
        serviceStatus = adminCustomerRoomInsertServiceResBean.getServiceStatus();
        ...
        if (ServiceStatusCode.OK.equals(serviceStatus)) {
            ...
            applicationLogger.log("Operator message room insert finished.", LogLevel.INFO);
