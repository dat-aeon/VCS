...
public class CouponCustomerListLazySorter implements Comparator<CustomerDataBean> {
    ...
    public CouponCustomerListLazySorter(String sortField, SortOrder sortOrder) {
        this.sortOrder = sortOrder;
        this.sortField = sortField;
    }

    public int compare(CustomerDataBean member1, CustomerDataBean member2) {
        ...
        try {
            ...
            applicationLogger.log("Coupon Customer List Sorter Process finished.", LogLevel.INFO);
