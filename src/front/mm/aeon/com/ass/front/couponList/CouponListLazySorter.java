...
public class CouponListLazySorter implements Comparator<CouponListLineBean> {
    ...
    public CouponListLazySorter(String sortField, SortOrder sortOrder) {
        this.sortOrder = sortOrder;
        this.sortField = sortField;
    }

    @Override
    public int compare(CouponListLineBean member1, CouponListLineBean member2) {
        applicationLogger.log("Coupon List Sorter Process started.", LogLevel.INFO);
        try {
            ...
            applicationLogger.log("Coupon List Sorter Process finished.", LogLevel.INFO);
