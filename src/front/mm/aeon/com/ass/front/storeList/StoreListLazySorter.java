...
public class StoreListLazySorter implements Comparator<StoreListLineBean> {
    ...
    public StoreListLazySorter(String sortField, SortOrder sortOrder) {
        this.sortOrder = sortOrder;
        this.sortField = sortField;
    }

    public int compare(StoreListLineBean member1, StoreListLineBean member2) {
        ...
        try {
            ...
            applicationLogger.log("Store List Sorter Process finished.", LogLevel.INFO);
